...
if(count > size){
	...
	if(key=='a' || key== 'A')
	{
		...
		glutInitWindowSize(1600, 800);
		glutInitWindowPosition(0, 0);
		glutCreateWindow("About Us");

		glutDisplayFunc(about_us);
		glutReshapeFunc(myReshape);
	}
...
void about_us(void)
{
	...
	glColor3f(0.1, 1.0, 1.0);
	drawstring(-3.0, 1.2, "NAME    :Sujay N Patel");
	drawstring(-3.0, 1.0, "USN     :4SU20CS112");
	drawstring(-3.0, 0.8, "PHONE NO:9483385227");
	drawstring(-3.0, 0.6, "ADDRESS :MALLESHWARA NILAYA OPP JNNCE");
	drawstring(-2.4, 0.4, "SHIMOGGA 577201");

	glColor3f(0.1, 1.0, 1.0);
	drawstring(-3.0, -0.6, "NAME    :VISHWANATH N");
	drawstring(-3.0, -0.8, "USN     :4SU20CS123");
	drawstring(-3.0, -1.0, "PHONE NO:9019336752");
	drawstring(-3.0, -1.2, "ADDRESS :SANYASI KODUMAGGE BHADRAVATHI (TQ)");
	drawstring(-2.4, -1.4, "SHIMOGGA 577201");

	glColor3f(0.1, 1.0, 1.0);
	drawstring(1.0, 1.2, "NAME    :YATHEESH PATEEL K G");
	drawstring(1.0, 1.0, "USN     :4SU20CS126");
	drawstring(1.0, 0.8, "PHONE NO:9845412533");
	drawstring(1.0, 0.6, "ADDRESS :VINOB NAGAR SHIMOGGA 577201");

	glColor3f(0.1, 1.0, 1.0);
	drawstring(1.0, -0.6, "NAME    :JOBIN JACOB");
	drawstring(1.0, -0.8, "USN     :4SU20CS400");
	drawstring(1.0, -1.0, "PHONE NO:8904164237");
	drawstring(1.0, -1.2, "ADDRESS :PERLA ROAD UJIRE 574240");
...
void about(void)
{
	...
	glColor3f(0.8, .2, 0.8);
	drawstring(-3.2, -0.7, "FOR ABOUT,PRESS ( A/a )");
...
glColor3f(0.5, 1, 1.0);
	drawstring(130, 320, "A COMPUTER GRAPHICS MINI PROJECT ON (18CS67)");
 ...
 glPushMatrix(); 
	...
	drawstring(25, 150, "Mr. Sujay N Patel(4SU20CS112)");
	drawstring(25, 130, "Mr. Vishwanath N(4SU20CS123)");
	drawstring(25, 110, "Ms. Yatheesh pateel KG(4SU20CS126)");
	drawstring(25, 90, "Mr.  Jobin Jacob(4SU21CS400)");
	...
	glColor3f(0.5, 1.0, 0.5);
	drawstring(313, 110, "Assistant Professor,");
	glColor3f(0.5, 1.0, 0.5);
	drawstring(313, 90, "Department of CSE");
	glPopMatrix();
